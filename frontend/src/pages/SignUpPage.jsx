...
const SignUpPage = () => {
    ...
    const registerHandler = async (e) => {
        ...
        try{
            ...
            const redirectTo = localStorage.getItem('redirectAfterRegister') || '/';
  ...
  return (
    <div className="w-full h-100 bg-black flex justify-content-center text-center">
        <div className="w-2/6 max-w-full px-3 m-auto my-32 shrink-0">
            <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div className="flex-auto px-6 py-5">
                    <form role="form text-left" onSubmit={registerHandler}>
                        <div className="mb-4">
                            <input 
                        ...
                        <div className="text-center">
                            <button className="inline-block w-full px-6 py-3 mt-5 mb-2.5 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer active:opacity-85 hover:scale-102 hover:shadow-soft-xs leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 bg-gradient-to-tl from-gray-900 to-slate-800 hover:border-slate-700 hover:bg-slate-700 hover:text-white" type="submit">Register</button>
                        </div>
                        <p className="mt-4 mb-0 leading-normal text-sm">
                            Already have an account? <Link to='/signin' className="font-bold text-slate-700">Login</Link>
                        </p>
                    </form>
